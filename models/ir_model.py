...
class IRModel(_BaseModel):
    ...
    def __init__(self, opt) -> None:
        ...
        if load_path is not None:
            if self.opt['name'] == "LAPAR-A_RSSR_x2" or self.opt['name'] == "LAPAR-B_RSSR_x2" or self.opt['name'] == "LAPAR-C_RSSR_x2" or self.opt['name'] == "HNCT_RSSR_x2" or self.opt['name'] == "FDIWN_RSSR_x2" or self.opt['name'] == "LBNet-T_RSSR_x2":
                param_key = None
            elif self.opt['name'] == "LAPAR-A_RSSR_x4" or self.opt['name'] == "LAPAR-B_RSSR_x4" or self.opt['name'] == "LAPAR-C_RSSR_x4" or self.opt['name'] == "HNCT_RSSR_x4" or self.opt['name'] == "FDIWN_RSSR_x4" or self.opt['name'] == "LBNet-T_RSSR_x4":
                param_key = None
            else:
